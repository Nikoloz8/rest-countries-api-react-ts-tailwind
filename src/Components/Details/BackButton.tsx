...
export default function BackButton() {
    ...
    return (
        <div className="flex items-start mt-[50px]!">
            <button onClick={() => navigate("/home")} className={`bg-[#2B3844] cursor-pointer text-[#FFFFFF] text-[1.6rem] leading-[20px] font-[300] w-[140px] h-[40px] rounded-[6px]! flex items-center justify-center gap-[12px] ${toggle ? "bg-[#FFFFFF]! text-[#111517]!" : undefined}`}>
